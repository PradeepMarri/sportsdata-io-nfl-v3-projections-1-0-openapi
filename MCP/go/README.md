# NFL v3 Projections MCP Server

This MCP (Model Content Protocol) server provides access to NFL v3 Projections API functionality through HTTP, HTTPS, and STDIO transport modes.
